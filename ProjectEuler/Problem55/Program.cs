...
namespace Problem55
{
    class Program
    {
        ...
        //and add process is called a Lychrel number. Due to the theoretical nature of these numbers,
        //and for the purpose of this problem, we shall assume that a number is Lychrel until proven otherwise.
        //In addition you are given that for every number below ten-thousand, it will either (i) become a palindrome
        ...
        //to require over fifty iterations before
        ...
        {
            List<BigInteger> lychrelNums = new List<BigInteger>();

            for (int i = 10; i < 10000; i++)
            {
                if (Util.IsLychrelNumber(i))
                {
                    lychrelNums.Add(i);
                }
            }
            
            Console.WriteLine(lychrelNums.Count);
