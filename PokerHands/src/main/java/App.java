...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Combinations.sevenChooseFive(possibleCards, 0, selected, allCombinations);
        ...
        for( PokerHand combination : allCombinations ){
            ...
            System.out.println("Count Hand: " + countHand);
            arr = combination.evaluateHand();
            countHand++;
            System.out.println("Hand Value: " + HandValue.returnValue(arr[0]));
            System.out.println("High Card Value: " + arr[1]);
            System.out.println();
        }
