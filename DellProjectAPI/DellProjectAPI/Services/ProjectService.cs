...
using DellProjectAPI.Persistence.Repos;
using DellProjectAPI.Exceptions;
...
namespace DellProjectAPI.Services
{
    public class ProjectService
    {
        ...
        {
            _eventRepo = new EFEventRepo(context);
            _activityRepo = new EFActivityRepo(context);
            _attendeeRepo = new EFAttendeeRepo(context);
